...
public class FavaritMusicsFragment extends Fragment {
    ...
    public static FavaritMusicsFragment newInstance() {

        Bundle args = new Bundle();

        FavaritMusicsFragment fragment = new FavaritMusicsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.recycle_view_favorite__music);
